// This file contain the code for the Random quiz generator from the list of questions stored in a file
...
function loadQuestions(){
    try{
        ...
        console.log("Erorr occur while loading the file", e);
        return [];
    }
} 
...
console.log("Time: ", Math.round(totalTime/1000) + " seconds") 
